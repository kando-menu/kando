...
- The top-level menu item in the configuration file is now called `"root"` instead of `"nodes"`. This is more consistent with the source code. You settings file will be automatically migrated when you start Kando.
