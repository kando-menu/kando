...
- Custom fonts in the settings dialog. If you used a custom font in your system, not all widgets were using this font. Now, all widgets should use your custom font.
