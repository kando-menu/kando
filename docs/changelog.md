...
- An issue which caused several installed apps not to be found on macOS. Thanks to [@skanpaul](https://github.com/skanpaul) for this fix!
- An issue which caused several system icons not to be found on Linux.
...
- Getting icons from the "hicolor" system icon theme on some Linux systems.
