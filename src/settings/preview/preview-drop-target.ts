...
export class PreviewDropTarget extends EventEmitter implements IDropTarget {
  ...
  private centerItem: ISettingsMenuItem = null;

  /** This is the parent item of the center item. */
  private parentItem: ISettingsMenuItem = null;
   ...
   * dropped.
   */
  private dropInto: ISettingsMenuItem | null = null;
   ...
   *   item.
   */
  public setCenterItem(centerItem: ISettingsMenuItem, parentItem: ISettingsMenuItem) {
  ...
  accepts(draggable: IDraggable, coords: IVec2) {
    ...
    if (
      ...
      draggable.getDataType() !== 'template-menu-item' &&
    ...
    const item = draggable.getData() as ISettingsMenuItem;
    return item.angle === undefined;
  }

  /** @inheritdoc */
  public onDragEnter(draggable: IDraggable) {
    this.emit('drag-enter', draggable.getData() as ISettingsMenuItem);
  }
  ...
  public onDragLeave(draggable: IDraggable) {
    this.dropIndex = null;
    this.dropInto = null;
    this.emit('drag-leave', draggable.getData() as ISettingsMenuItem);
  }
