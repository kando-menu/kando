...
export class MenusTab extends DropTargetTab {
   ...
   * update the settings. When the settings is closed, the settings are saved to disc.
   */
   ...
   * whenever the settings is opened.
   *
   * @param menuSettings The settings contain all menus and their properties.
