 ...
 * path.
 */
export function FileItemConfig() {
...
/** The tips component for file items shows a list of useful tips for file items. */
export function getFileItemTips() {
  return [i18next.t('menu-items.file.tip-1')];
}
