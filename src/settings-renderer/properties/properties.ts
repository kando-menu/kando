...
import { IMenu, IBackendInfo, IShowSettingsOptions } from '../../common';
...
export class Properties extends EventEmitter {
  ...
  /**
   * The settings div contains the elements shown when the user is editing the root item
   * of a menu.
   */
   ...
   */
  public async setItem(item: ISettingsMenuItem) {
    this.iconPicker.hide();
    this.conditionPicker.hide();
    this.advancedOptionsPicker.hide();
   ...
   */
  public setOptions(options: IShowSettingsOptions) {
   ...
   * @param item The menu item whose properties should be displayed.
   */
  private updateItemSettingsWidgets(item: ISettingsMenuItem) {
