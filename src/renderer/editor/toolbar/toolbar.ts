      ...
      tabs: [
        {
          id: 'kando-menus-tab',
          icon: 'apps',
          title: i18next.t('toolbar.menus-tab'),
          active: true,
          content: '',
        },
        {
          ...
          title: i18next.t('toolbar.add-items-tab'),
          content: '',
        },
        {
          id: 'kando-templates-tab',
          icon: 'content_copy',
          title: i18next.t('toolbar.templates-tab'),
          hasCounter: true,
          content: '',
        },
        {
          id: 'kando-trash-tab',
          icon: 'delete',
          title: i18next.t('toolbar.trash-tab'),
          hasCounter: true,
          content: '',
        },
        {
          ...
          icon: 'palette',
          title: i18next.t('toolbar.menu-themes-tab'),
          gapBefore: true,
          content: '',
        },
        {
          ...
          icon: 'palette',
          title: i18next.t('toolbar.editor-themes-tab'),
          content: emptyTab({
